...
function showHideSettings(payload) {
    ...
    setCommandModeSettings(displayValue(payload.modeCommand));
...
function setCommandModeSettings(displayValue) {
    var commandModeSettings = document.getElementById('commandModeSettings');
    commandModeSettings.style.display = displayValue;
}
